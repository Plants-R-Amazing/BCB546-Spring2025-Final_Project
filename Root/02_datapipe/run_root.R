...
#### CHANGE THIS PATHS ####
source <- "r_analysis_proj_root"
path.in <- "/lab/biohpc/students/sadiya/r_analysis_proj_root/01_demultiplex/out/" #needs a "/" at the end
path.primer <- "/lab/biohpc/students/sadiya/r_analysis_proj_root/01_demultiplex/" #needs a "/" at the end
path.rds <- "RDS/"
path.out <- "output/"
taxa_database <- "/lab/biohpc/students/sadiya/r_analysis_proj_root/utax_reference_dataset_10.05.2021.fasta"
